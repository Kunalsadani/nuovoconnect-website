...
import { ArrowRight, Wallet, ShoppingCart, ScanLine, Layers, Landmark, Radio, Banknote, Gamepad2 } from "lucide-react";
...
export function WhoWeServeClient() {
  const sectors = [
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-28 overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 leading-tight" data-testid="text-serve-title">Grow your business with our industry-specific solutions</h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">We provide tailored solutions for every sector, backed by the region-specific intelligence you need to curate the ideal product mix for your audience.</p>
            <Link href="/contact">
              <Button size="lg" className="rounded-full px-8" data-testid="button-serve-demo">Get in Touch <ArrowRight className="ml-2 w-5 h-5" /></Button>
            </Link>
          </motion.div>
        </div>
                ...
                <Card className="h-full border-border hover:border-primary/30 transition-all group">
                  <CardContent className="p-8">
                    ...
                    <Link href={sector.href}>
                      <span className="text-primary font-semibold text-sm flex items-center gap-1 cursor-pointer hover:gap-2 transition-all">Learn more <ArrowRight size={14} /></span>
                    </Link>
                  </CardContent>
                </Card>
              </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Ready to explore bespoke solutions for your business?</h2>
          <Link href="/contact">
