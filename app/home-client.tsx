  ...
  return (
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white">
        <div aria-hidden className="absolute pointer-events-none hero-glow" style={{ top: "10%", left: "30%", width: "800px", height: "600px", zIndex: 0 }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/contact">
                  <Button size="lg" data-testid="button-hero-contact" className="btn-gradient rounded-full px-8 text-base">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            <span className="text-sm font-semibold uppercase tracking-wider" style={{ color: "#7C3AED", letterSpacing: "0.05em" }}>Our Offerings</span>
            <h2 className="text-3xl md:text-5xl font-display font-bold mt-3 mb-6 text-foreground">Digital products tailored for every region</h2>
          </motion.div>
      ...
      <section className="py-24" style={{ backgroundColor: "#F0F4FF" }}>
        <div className="container mx-auto px-4 md:px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-6 text-foreground">Purpose-built solutions for every industry</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {sectors.map((sector, i) => (
              <motion.div key={i} {...fadeUp} transition={{ delay: i * 0.08 }} whileHover={{ y: -4 }} className="rounded-2xl shadow-[0_6px_24px_rgba(13,27,75,0.08)]">
                <Link href={sector.href}>
                  <span className="p-5 md:p-6 rounded-2xl bg-white border border-border flex items-center gap-3 md:gap-4 cursor-pointer transition-colors hover:border-primary/40 min-w-0"
          ...
          <div className="text-center mt-10">
            <Link href="/who-we-serve">
              <Button className="btn-gradient rounded-full px-8">Who We Serve <ArrowRight className="ml-2 w-4 h-4" /></Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <motion.div {...fadeUp}>
            <h2 className="text-3xl md:text-5xl font-display font-bold mb-6 text-white">Activate and grow your customer base</h2>
            <Link href="/contact">
