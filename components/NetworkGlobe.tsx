...
const STROKE = "rgba(124, 58, 237, 0.30)";
...
export function NetworkGlobe() {
  return (
    <div className="relative w-full h-full min-h-[400px] flex items-center justify-center">
      <div className="absolute inset-0 blur-[100px] rounded-full" style={{ backgroundColor: "rgba(167,139,250,0.20)" }} />
      ...
      <svg viewBox="0 0 400 400" className="w-full h-full max-w-[500px] animate-[spin_60s_linear_infinite]">
        ...
        <motion.ellipse cx="200" cy="200" rx="180" ry="80" stroke={STROKE} strokeWidth="1" fill="none" transform="rotate(45, 200, 200)" />
        <motion.ellipse cx="200" cy="200" rx="180" ry="80" stroke={STROKE} strokeWidth="1" fill="none" transform="rotate(-45, 200, 200)" />
        <motion.ellipse cx="200" cy="200" rx="180" ry="40" stroke={STROKE_SOFT} strokeWidth="1" fill="none" />
        {[...Array(8)].map((_, i) => (
          <motion.circle
            key={i}
